package com.dwl.canal_client.client;
...
public class CanalClient {
    ...
    public void run() {
        ...
        CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("182.92.110.240",
                11111), "example", "", "");
        int batchSize = 1000;
        try {
            connector.connect();
            connector.subscribe("guli_edu.t_pay_log");
            connector.rollback();
            try {
                while (true) {
            ...
            for (RowData rowData : rowDatasList) {
                ...
                for (int i = 0; i < newColumnList.size(); i++) {
                    if (newColumnList.get(i).getIsKey()) {
                        System.out.println(newColumnList.get(i).getValue() + "--------------------");
                        System.out.println(newColumnList.get(i).getName() + "--------------------");
                        continue;
                    }
